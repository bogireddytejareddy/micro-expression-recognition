...
filepath="weights_intermediate_microexpfusenet/weights-improvement-{epoch:02d}-{val_acc:.2f}.hdf5"
...
etrain_images, evalidation_images, etrain_labels, evalidation_labels =  train_test_split(ntraining_set, nose_traininglabels, test_size=0.2)
...
# Training the model
history = model.fit([etrain_images, ntrain_images], etrain_labels, validation_data = ([etraining_set, ntraining_set], eye_traininglabels), callbacks=callbacks_list, batch_size = 4, nb_epoch = 250, shuffle=True)
