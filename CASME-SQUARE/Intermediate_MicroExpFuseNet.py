...
eye_traininglabels[0:75] = 0
eye_traininglabels[75:168] = 1
eye_traininglabels[168:203] = 2

nose_traininglabels[0:75] = 0
nose_traininglabels[75:168] = 1
nose_traininglabels[168:203] = 2
...
etraining_set = numpy.zeros((eye_trainingsamples, 1, 32, 32, 96))
...
ntraining_set = numpy.zeros((nose_trainingsamples, 1, 32, 32, 96))
...
numpy.save('numpy_training_datasets/intermediate_microexpfusenetnoseimages.npy', ntraining_set)
numpy.save('numpy_training_datasets/intermediate_microexpfuseneteyeimages.npy', etraining_set)
numpy.save('numpy_training_datasets/intermediate_microexpfusenetnoselabels.npy', nose_traininglabels)
numpy.save('numpy_training_datasets/intermediate_microexpfuseneteyelabels.npy', eye_traininglabels)

# Load training images and labels that are stored in numpy array
"""
ntraining_set = numpy.load('numpy_training_datasets/intermediate_microexpfusenetnoseimages.npy')
etraining_set = numpy.load('numpy_training_datasets/intermediate_microexpfuseneteyeimages.npy')
eye_traininglabels = numpy.load('numpy_training_datasets/intermediate_microexpfusenetnoselabels.npy')
nose_traininglabels = numpy.load('numpy_training_datasets/intermediate_microexpfuseneteyelabels.npy')
"""

# Intermediate MicroExpFuseNet Model
eye_input = Input(shape = (1, 32, 32, 96))
...
nose_input = Input(shape = (1, 32, 32, 96))
...
filepath="weights_IF/weights-improvement-{epoch:02d}-{val_acc:.2f}.hdf5"
...
etrain_images, evalidation_images, etrain_labels, evalidation_labels =  train_test_split(etraining_set, eye_traininglabels, test_size=0.2)
ntrain_images, nvalidation_images, ntrain_labels, nvalidation_labels =  train_test_split(ntraining_set, nose_traininglabels, test_size=0.2)

# Save validation set in a numpy array
numpy.save('numpy_validation_datasets/intermediate_microexpfusenet_eval_images.npy', evalidation_images)
numpy.save('numpy_validation_datasets/intermediate_microexpfusenet_nval_images.npy', nvalidation_images)
numpy.save('numpy_validation_datasets/intermediate_microexpfusenet_eval_labels.npy', evalidation_labels)
numpy.save('numpy_validation_datasets/intermediate_microexpfusenet_nval_labels.npy', nvalidation_labels)
...
"""
eimg = numpy.load('numpy_validation_datasets/intermediate_microexpfusenet_eval_images.npy')
nimg = numpy.load('numpy_validation_datasets/intermediate_microexpfusenet_nval_images.npy')
labels = numpy.load('numpy_validation_datasets/intermediate_microexpfusenet_eval_labels.npy')
"""
