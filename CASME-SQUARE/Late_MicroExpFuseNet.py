...
"""
model.load_weights('weights_late_microexpfusenet/weights-improvement-17-0.79.hdf5')
"""
...
# Training the model
hist = model.fit([etrain_images, ntrain_images], etrain_labels, validation_data = ([etraining_set, ntraining_set], eye_traininglabels), callbacks=callbacks_list, batch_size = 16, nb_epoch = 100, shuffle=True)
...
lab = numpy.load('numpy_validation_datasets/late_microexpfusenet_eval_labels.npy')
"""
...
validation_labels = numpy.argmax(lab, axis=1)
